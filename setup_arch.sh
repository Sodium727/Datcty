...
# Essentials
sudo pacman -Sy --noconfirm --needed git base-devel clang xclip dos2unix tree fastfetch qbittorrent htop gdb ripgrep neovim imv dosfstools ntfs-3g bat exa zoxide fcitx5 fcitx5-unikey fcitx5-qt fcitx5-gtk fcitx5-configtool 
