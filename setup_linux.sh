...
sudo apt install -y git build-essential clangd xclip dos2unix ibus-unikey tree firefox libreoffice usb-creator-gtk qbittorrent btop htop zenity gnome-disk-utility
